...
## report that called the stride too far and jerky once the rest-pose
## composition bug stopped masking how big these angles actually read.
const THIGH_SWING := 0.22
const SHIN_FOLD := 0.38
