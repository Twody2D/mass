...
> ⚠️ **Статус: остров и 10 000 видимых ботов есть, движения ещё нет** — см. [TODO.md](TODO.md).
...
команд. Камерой можно свободно летать и подлететь к ним вплотную. Боты пока **стоят на месте**:
движение — следующий шаг.

На Intel UHD Graphics это около 106 FPS при 10 000 ботов.
